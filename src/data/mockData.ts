import { CaseItem, CaseNote, DocumentItem, AuditLog, User, CaseReport, Workspace, AppNotification, Subscription, Invoice } from '../types';
...
export const mockWorkspaces: Workspace[] = [
  {
    id: 'ws-1',
    name: 'Workspace ملکی برج آریا',
    description: 'پرونده‌ها و اسناد مرتبط با مجتمع تجاری آریا و معاملات وابسته',
    ownerId: 'usr-1',
    memberIds: ['usr-1', 'usr-2', 'usr-3'],
    caseIds: ['case-101', 'case-102'],
  ...
  {
    id: 'ws-2',
    name: 'Workspace قراردادهای سازمانی',
    description: 'بازبینی قرارداد و اختلافات تجاری',
    ownerId: 'usr-1',
    memberIds: ['usr-1'],
    caseIds: [],
    createdAt: '۱۴۰۳/۰۱/۱۰',
    updatedAt: '۱۴۰۳/۰۴/۲۰',
    status: 'active',
  },
];
...
export const mockNotifications: AppNotification[] = [
  ...
  },
  {
    ...
    body: 'جلسه پرونده برج آریا در تاریخ ۱۴۰۳/۰۵/۲۰ برگزار می‌شود.',
    channel: 'in_app',
    read: false,
  ...
  },
  {
    ...
    body: 'مبایعه‌نامه به‌روزرسانی‌شده به مرکز اسناد اضافه شد.',
    channel: 'email',
    read: false,
  ...
  },
  {
    id: 'notif-3',
    userId: 'usr-1',
    title: 'تحلیل AI آماده است',
    body: 'گزارش ریسک پرونده سعادت‌آباد تولید شد.',
    channel: 'sms',
    read: true,
...
export const initialCases: CaseItem[] = [
  {
    ...
    history: [
      { id: 'h1', caseId: 'case-101', action: 'ایجاد پرونده', actorName: 'دکتر صادقی', timestamp: '۱۴۰۲/۰۶/۱۵' },
      { id: 'h2', caseId: 'case-101', action: 'بارگذاری سند تک‌برگ', actorName: 'مهندس تهرانی', timestamp: '۱۴۰۲/۰۶/۱۶' },
      { id: 'h3', caseId: 'case-101', action: 'ثبت وقت دادگاه', actorName: 'دکتر صادقی', timestamp: '۱۴۰۳/۰۴/۲۰' },
    ],
    legalDetails: {
  ...
  {
    id: 'case-ai-1',
    title: 'تحلیل AI — پرونده نمونه Sprint 5',
    caseNumber: '۱۴۰۳/۲۰۰/۰۰۱',
    category: 'real_estate',
    status: 'ai_analyzing',
    priority: 'high',
    description: 'پرونده نمونه برای demo وضعیت ai_analyzing و Draft Review.',
    tags: ['AI', 'تحلیل', 'demo'],
    assignedAdvocate: 'DecisionOS AI',
    assignedExpertId: 'usr-1',
    workspaceId: 'ws-1',
  ...
  },
  {
    ...
    updatedAt: '۱۴۰۳/۰۵/۰۱',
    history: [
      { id: 'h4', caseId: 'case-102', action: 'ایجاد پرونده', actorName: 'دکتر صادقی', timestamp: '۱۴۰۲/۱۱/۰۴' },
      { id: 'h5', caseId: 'case-102', action: 'تحلیل AI', actorName: 'سیستم', timestamp: '۱۴۰۳/۰۵/۰۱' },
    ],
    legalDetails: {
  ...
  },
  {
    ...
    history: [
      { id: 'h6', caseId: 'case-103', action: 'ثبت تجدیدنظر', actorName: 'مهندس تهرانی', timestamp: '۱۴۰۳/۰۱/۱۰' },
    ],
    legalDetails: {
  ...
  },
  {
    ...
    history: [
      { id: 'h7', caseId: 'case-104', action: 'ایجاد پرونده', actorName: 'دکتر صادقی', timestamp: '۱۴۰۳/۰۲/۱۰' },
    ],
    legalDetails: {
