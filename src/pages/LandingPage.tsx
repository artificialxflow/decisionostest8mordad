...
const industries = [
  ...
  { id: 'real_estate', label: 'خرید و فروش ملک' },
  { id: 'holding', label: 'هلدینگ تجاری' },
  { id: 'investment', label: 'مشاوره سرمایه‌گذاری' },
...
const journey = [
  { title: 'درخواست مشاوره', desc: 'نیاز حقوقی، ملک، هلدینگ تجاری یا سرمایه‌گذاری؟' },
  { title: 'پاسخ اولیه سیستم', desc: 'مشاوره رایگان سیستمی — بدون نمایش متخصص' },
  { title: 'درخواست مشاوره تخصصی', desc: 'اگر راضی نشدید، متخصص را ببینید و انتخاب کنید' },
];
        ...
        <div className="max-w-6xl mx-auto px-4 py-14 md:py-20 grid lg:grid-cols-2 gap-10 items-center relative">
          ...
          >
            ...
            <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed max-w-lg">
              کمک می‌کنیم بفهمید چه می‌خواهید — هلدینگ تجاری، خرید و فروش ملک، قرارداد یا دعوای حقوقی — سپس با فرم حداقلی، پاسخ سیستم و در صورت نیاز متخصص، مسیر تصمیم را شفاف می‌کنیم.
            </p>
