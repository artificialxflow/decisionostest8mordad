...
export const AuthModal: React.FC<AuthModalProps> = ({ isOpen, onClose, onLoginSuccess }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const loggedUser: User = {
      ...
      role,
      licenseNumber,
      organization: role === 'expert' || role === 'advocate' ? 'کانون وکلای دادگستری' : 'دپارتمان حقوقی DecisionOS',
          ...
          {isRegister && (
            <>
              ...
              <div>
                ...
                >
                  <option value="client">موکل / مشتری</option>
                  <option value="expert">متخصص / کارشناس</option>
